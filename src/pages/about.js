...
const About = ({data}) => (
	<Layout meta={meta}>
		...
		<p>I decided to become a Registered Marriage Celebrant because I was bored with my job at the time and I decided that I wanted to be my own boss and work in an industry that gave me a fabulous sense of achievement.</p>
